...
w2 = Label(root, justify=LEFT, text=" Disease Prediction From Symptoms ",fg="black",bg="Ivory")
...
S1Lb = Label(root,  text="Symptom 1",fg="red",bg="Ivory")
S1Lb.config(font=("Times", 20,"bold italic"))
S1Lb.grid(row=7, column=1, pady=10 , sticky=W)

S2Lb = Label(root,  text="Symptom 2",fg="red",bg="Ivory")
S2Lb.config(font=("Times", 20,"bold italic"))
S2Lb.grid(row=8, column=1, pady=10, sticky=W)

S3Lb = Label(root,  text="Symptom 3",fg="red",bg="Ivory")
S3Lb.config(font=("Times", 20,"bold italic"))
S3Lb.grid(row=9, column=1, pady=10, sticky=W)

S4Lb = Label(root,  text="Symptom 4",fg="red",bg="Ivory")
S4Lb.config(font=("Times", 20,"bold italic"))
S4Lb.grid(row=10, column=1, pady=10, sticky=W)

S5Lb = Label(root,  text="Symptom 5",fg="red",bg="Ivory")
S5Lb.config(font=("Times", 20,"bold italic"))
S5Lb.grid(row=11, column=1, pady=10, sticky=W)

lr = Button(root, text="Predict",height=2, width=20, command=message,fg="black",bg="Ivory")
lr.config(font=("Times", 20,"bold italic"))
